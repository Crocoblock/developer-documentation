...
![Booking Cancellation Settings](assets/booking-cancellation-settings.png "Booking Cancellation Settings")
...
The first way is possible only if you have the WooCommerce plugin activated on your site. More about this can be found [here](../01-booking-list-in-wc-my-account-page). Under these conditions and cancellation settings, lists of client bookings will be displayed in a special bookings endpoint if the booking can be canceled, and a cancellation button will be available in the last column.
...
![Booking Cancellation Confirmation Window](assets/booking-cancel-confirmation.png "Booking cancellation confirmation window")
...
![Booking Cancellation WoCommerce Notice](assets/booking-cancel-notice.png "Message after cancellation")
...
![Booking Cancellation with Dynamic Link Widget](assets/dynamic-link-widget-cancel-source.png "Booking cancellation with dynamic link widget")
...
![Booking Cancellation Dynamic Visibility](assets/dynamic-visibility-for-booking-cancellation.png "Booking cancellation dynamic visibility")
